...
import { vendorGet } from '../services/api-services'
...
<div >
<button style={{marginTop:'10px'}} onClick={()=>Navigate('/Vendor-list')} className='btn view-close btn-gradient-primary me-2'>Close</button>
