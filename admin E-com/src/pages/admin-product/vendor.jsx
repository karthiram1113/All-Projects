...
import { vendorDelete, vendorLists } from '../../services/api-services';
...
const vendorList = async (page) => {
  ...
  try {
    const responseData = await vendorLists(page - 1, recordsPerPage);
...
>
  {list.status}
                            ...
                            <td className="clients">
                              <li>
                                <Link to={{ pathname: `/admin-vendor-view/${list.id}` }} className="eye">
                                  <i className="fa-solid fa-eye eye"></i>
                                </Link>
                              </li>
                              <li>
                                <Link to={{ pathname: `/Vendorformpage/Edit/${list.id}` }} className="edit">
