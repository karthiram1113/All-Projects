...
import '../shoptype-list/shopType.css'
...
const shopList = async (page) => {
  ...
  try {
    const responseData = await shopTypeLists(page - 1, recordsPerPage);
  ...
  //   try {
  //     const responseData = await shopTypeLists(0, 20); // Updated to pass correct parameters
  ...
  const shopTypeDeleteApi = async (e) => {
    ...
    try {
      const responseData = await shopTypeDelete(deleteId);
        ...
        <div style={{ paddingTop: "80px" }} className="main-panel">
          <div className="content-wrapper">
            <div className="page-header">
              ...
              <button onClick={()=>navigate("/shoptypeformpage/" + "Create")} style={{ float: "right",marginBottom:"20px" }} type="button" class="button">
                        ...
                        {list.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td className="clients">
                              ...
                              <li>
                                <Link to={`/Shoptypeformpage/Edit/${item.id}`} className="edit">
...
<Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Shoptype Delete</Modal.Title>
        </Modal.Header>
        ...
        <Modal.Footer>
          ...
          <Button className='btn btn-gradient-primary me-2' variant="primary" onClick={shopTypeDeleteApi}>
            Delete
          </Button>
        </Modal.Footer>
      </Modal>
