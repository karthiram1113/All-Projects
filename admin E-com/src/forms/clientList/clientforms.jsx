...
import { clientEditFunction, clientGet } from '../../services/api-services'
...
<button  onClick={()=>Navigate("/Client-list")} class="btn btn-light">Cancel</button>
            <button type="submit" onClick={clientEdit} class="btn btn-gradient-primary me-2">Submit</button>
