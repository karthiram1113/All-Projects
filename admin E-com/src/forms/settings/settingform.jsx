...
import { settingEditFunction, systeminfoLists } from '../../services/api-services';
...
function Settingform() {
 ...
 const handleFileChange = (e) => {
  ...
  const systemList = async () => {
    try {
        const response = await systeminfoLists();
     ...
     const settingEdit = async (e) => {
        ...
        try {    
          ...
          const responseData = await settingEditFunction(
...
{/* 
  <div class="note-resizebar" aria-label="Resize">
      ...
      <div class='note-icon-bar'></div>
        ...
        <div className='col-md-6'>
                <img style={{width:"150px",height:"150px",borderRadius:"50%"}} src={environment.apiBaseUrl+systemLogo} />
                {/* <img style={{width:"150px",height:"150px"}} src='/assets/images/hs.logo.png' /> */}

        </div>
        <div className='col-md-6'>
        <img style={{width:"150px",height:"150px",borderRadius:"50%"}} src={environment.apiBaseUrl+websiteCover} />
            
        </div>

                        </div>

        <button type="submit" style={{marginTop:"50px"}} onClick={settingEdit} class="btn btn-gradient-primary me-2">Update</button>  
