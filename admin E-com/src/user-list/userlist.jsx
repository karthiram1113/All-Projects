...
const userList = async (page) => {
  ...
  try {
    const responseData = await adminUserList(page - 1, recordsPerPage);
   ...
   const renderPaginationItems = () => {
    ...
    //     try {
    //       const responseData = await adminUserList(0, 20); 
  ...
  const userDeleteApi = async (e) => {
    ...
    try {
      const responseData = await userDelete(deleteId);
      ...
      <div style={{ paddingTop: "80px" }} className="main-panel">
        <div className="content-wrapper">
          <div className="page-header">
            ...
            <button onClick={()=>navigate("/userformpage/" + "Create")} style={{ float: "right",marginBottom:"20px" }} type="button" class="button">
                    ...
                    <tbody>
                      {list.map((item, index) => (
                        <tr key={index}>
                          ...
                          <td>
                            <img
                              src={item.avatar ? `${environment.apiBaseUrl}${item.avatar}` : "/assets/images/noimages.jpg"}
                              alt="Product Image"
                          ...
                          <td className="clients">
                            ...
                            <li>
                              <Link to={`/userformpage/Edit/${item.id}`} className="edit">
...
<Modal show={show} onHide={handleClose}>
      ...
      <Modal.Footer>
        ...
        <Button onClick={userDeleteApi} className='btn btn-gradient-primary me-2' variant="primary" >
          Delete
        </Button>
      </Modal.Footer>
    </Modal>
