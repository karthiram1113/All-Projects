...
function Sidenav() {
  ...
  //   location.pathname.includes('/monthlyreport')
  // );
    ...
    {/* <li className="nav-item nav-profile">
      <a href="#" className="nav-link d-flex align-items-center gap-2">
        ...
        <i className="mdi mdi-bookmark-check text-success nav-profile-badge"></i>
          ...
          <li className={`nav-item  ${location.pathname.includes('/dashboard') ? 'active' : 'collapsed'}`}>
            <Link to="/dashboard" className="nav-link d-flex align-items-center gap-2" onClick={closeSidebarOnMobile} >
        ...
        <span className="menu-title">Dashboard</span>
          ...
          {role === 'super_admin' && 
          <>
            <li className={`nav-item ${location.pathname.includes('/vendorlist') || location.pathname.includes('/vendor') || location.pathname.includes('/vendorview') ? 'active' : 'collapsed'}`}>
              <Link to="/vendorlist" className="nav-link d-flex align-items-center gap-2" onClick={closeSidebarOnMobile}>
            ...
            <li className={`nav-item ${location.pathname.includes('/clientlist') || location.pathname.includes('/client') ? 'active' : 'collapsed'}`}>
              <Link to="/clientlist" className="nav-link d-flex align-items-center gap-2" onClick={closeSidebarOnMobile}>
                <i className="nav-icon fas fa-user-friends menu-icon"></i>
                <span className="menu-title" >Client List</span>

              </Link>
            </li>
            <li className={`nav-item ${location.pathname.includes('/userlist') || location.pathname.includes('/user') ? 'active' : 'collapsed'}`}>
              <Link to="/userlist" onClick={closeSidebarOnMobile} className="nav-link d-flex align-items-center gap-2">
          ...
          {role === 'vendor' && 
          <>
            <li className={`nav-item ${location.pathname.includes('/productlist') || location.pathname.includes('/product') ? 'active' : 'collapsed'}`}>
              <Link to="/productlist" className="nav-link d-flex align-items-center gap-2" onClick={closeSidebarOnMobile} >
                <i className="nav-icon fas fa-store menu-icon"></i>
                <span className="menu-title" >Product List</span>

              </Link>
            </li>
            <li className={`nav-item ${location.pathname.includes('/orderlist') || location.pathname.includes('/order') ? 'active' : 'collapsed'}`}>
              <Link to="/orderlist" className="nav-link d-flex align-items-center gap-2" onClick={closeSidebarOnMobile}>
            ...
            <li className={`nav-item ${location.pathname.includes('/monthlyreport') ? 'active' : 'collapsed'}`}>

              <Link to={"/monthlyreport"} onClick={closeSidebarOnMobile} className="nav-link d-flex align-items-center gap-2" >
      ...
      <ul class="nav flex-column mb-0">
              ...
              <li className={`nav-item ${location.pathname.includes('/monthlyreport') ? 'sub-active' : 'collapsed'}`}>
