          ...
          <div class="layout-page">
            ...
            <div class="content-wrapper">
              <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4 text-start">
                <Link to={'/dashboard'}>
                <span class="text-muted fw-light">Dashboard /</span> </Link>
                  My Profile
                </h4>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                      <h5 class="card-header text-start">Profile Details</h5>
                      <div class="card-body">
                          ...
                          <div class="row text-start">
                            ...
                            <div class="mb-3 col-md-6">
                              ...
                              <input
                                ...
                                id="email"
                                name="email"
                                value="bk@example.com"
                                placeholder="bk@example.com"
                              />
                            </div>
                            <div class="mb-3 col-md-6">
