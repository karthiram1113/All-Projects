...
function MyProfile() {
  ...
  console.log(imgName, imgid, "imgName");
              ...
              <div class="card">
                <div class="profiles card-body profile-card pt-4 d-flex flex-column align-items-center">
                  ...
                  <div class="social-links mt-2">
                    <a href={twitter ? twitter : "https://twitter.com/?lang=en"} class="twitter" target="_blank"><i class="bi bi-twitter" style={{ color: "#1DA1F2" }}></i></a>
                    <a href={facebook ? facebook : "https://www.facebook.com/"} class="facebook" target="_blank"><i class="bi bi-facebook" style={{ color: "#1877F2" }}></i></a>
                    <a href={instagram ? instagram : "https://www.instagram.com/accounts/login/?hl=en"} class="instagram" target="_blank"><i class="bi bi-instagram" style={{
                      backgroundImage: "linear-gradient(to right, #feda75, #fa7e1e, #d62976, #962fbf)",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent"
                    }}></i></a>
                    <a href={linkedIn ? linkedIn : "https://www.linkedin.com/login"} class="linkedin" target="_blank"><i class="bi bi-linkedin" style={{ color: "#2164F3" }}></i></a>
                  </div>
                </div>
              </div>
                    ...
                    <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                      ...
                      <form>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-8 col-lg-9">
                            <input name="phone" onChange={(e) => setPhone(e.target.value)} maxLength={12} type="text" class="form-control" id="Phone" value={phone} />
                          </div>
                        </div>
                        ...
                        <div class="text-center">
                          {/* <Link to={"/Dashboard"}> */}
                          <button onClick={userProfileEdit} class="btn btn-primary">
                            Save Changes</button>
                          {/* </Link> */}
                        </div>
