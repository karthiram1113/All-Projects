...
function Hosting() {
  ...
  const hostingList = async (page) => {
    ...
    const response = await fetch(Url.start + Url.hostingList, {
      method: "POST",
      headers: {
        ...
        >
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body">Are You Sure Want To Delete Host Name <span style={{ color: "red", overflow: "hidden", wordBreak: "break-all" }}>{value}</span>?</div>
