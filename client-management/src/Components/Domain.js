...
function Domain() {
  ...
  const domainList = async (page) => {
    ...
    const response = await fetch(Url.start + Url.domainList, {
      method: "POST",
      headers: {
        ...
        >
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body">Are You Sure Want To Delete Domain Name <span style={{ color: "red", overflow: "hidden", wordBreak: "break-all" }}>{value}?</span></div>
