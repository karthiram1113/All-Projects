            ...
            <div class="container">
              <div class="row justify-content-center">
                      ...
                      <form class="row  g-3 needs-validation" novalidate>
                        <div class="col-12">
                          ...
                          value={password}
                            ...
                            class="form-control"
                            style={submit&& (password.length == 0 || password.length < 3) ?{borderColor:"red"}:{borderColor:""}}
                ...
                ></i>  
                          ...
                          {submit && password.length < 3 && password.length != 0 ? <div className="text-danger">Current Password must be 3 charater</div>:<></>}
                        </div>
                        <div class="col-12">
                          <label class="form-label">
                            Password
                          ...
                          <div className='password-input-container'>
                            <input
                              ...
                              class="form-control"
                              style={submit && (password1.length == 0 || password1 != password2) ? { borderColor: "red" } : { borderColor: "" }}
