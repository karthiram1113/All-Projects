...
<li class="nav-item">
    ...
    <div class="collapse" id="maintenanceModule">
      <ul class="nav flex-column sub-menu">
        ...
        <li class="nav-item">
          <Link to={"/adminshoplist"} class="nav-link" >Shop Type List</Link>
        </li>
      
        <li class="nav-item">
          <Link to={"/adminuserlist"} class="nav-link" href="#">User List</Link>
        </li>
      
        <li class="nav-item">
          <Link to={"/adminsetting"} class="nav-link" href="#">Setting</Link>
        </li>
      </ul>
    </div>
  </li>
    ...
    <div class="collapse" id="reportsModule">
      <ul class="nav flex-column sub-menu">
        ...
        <li class="nav-item">
           <Link to={"/adminreport"} class="nav-link" href="#">Monthly Order Report</Link>
        </li>
      </ul>
    </div>
  </li>
