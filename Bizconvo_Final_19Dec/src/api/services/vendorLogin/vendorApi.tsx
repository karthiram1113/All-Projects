...
//ApiCredentials
const ApiCredentialsgetAPI=API_EP_BOOK.API_CREDENTIALS_GET_API_EP;
const ApiCredentialstokenGenAPI=API_EP_BOOK.API_CREDENTIALS_TOKENGEN_API_EP;
...
const VendorAPI = {
    ...
    //ApiCredentials
    ApiCredentialsgetAPI: function () {
         const requestAPIData = {
            url: ApiCredentialsgetAPI.url,
            method: ApiCredentialsgetAPI.method,
            authorization: ApiCredentialsgetAPI.authorization,
        };
        return API(requestAPIData);
    },
    ApiCredentialstokenGenAPI: function (apiData: any) {
        const requestAPIData = {
            bodyData: apiData
        }; const getResponse = API(ApiCredentialstokenGenAPI, requestAPIData);
        return getResponse;
    },
    // ApiCredentials END
}
