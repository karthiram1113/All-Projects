...
import Api_Setup from "./views/Vendor/Api-integration";
import WhatsappFlowCreate from "./views/WhatsApp/Flows/create/flows";
import WhatsappFlowList from "./views/WhatsApp/Flows/list/list";
  ...
  useEffect(() => {
    ...
    <div className="App">
      <Routes>
        ...
        <Route path='/vendor/settings/api-setup' element={<Api_Setup />} />
        ...
        <Route path="vendor/whatsapp-flow/create" element={<WhatsappFlowCreate/>}/>
        <Route path="vendor/whatsapp-flow/list" element={<WhatsappFlowList/>}/>
      </Routes>
      <ToastContainer
