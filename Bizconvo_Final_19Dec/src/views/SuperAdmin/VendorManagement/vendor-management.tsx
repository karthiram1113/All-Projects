...
useEffect(() => {
   ...
   return (
      <DashboardLayout>
                                          ...
                                          {listVendor.map((vendorItem: any) => (
                                             <tr key={vendorItem.id}>
                                                ...
                                                <td className="align-middle vendor-login-td">
                                                   ...
                                                   {/* <div className="actionSettings-tooltip-container">
                                                      <button className="btn-3 vendorbtn-settings" type="button" data-bs-toggle="modal" data-bs-target="#vendorSettings" onClick={() => { superAdminVendorListGet(vendorItem?.VendorId); }}>
                                                         <span className="btn-inner--icon"><i className="fa-solid fa-gear"></i></span>
                                                      </button>&nbsp;
                                                      <div className="actionSettings-tooltip-text">
                                                         Settings
                                                      </div>
                                                   </div> */}
         ...
         {/*Vendor Create and Edit Modal*/}
         <div className="modal fade" id="vendorSettings" tab-index="-1" aria-labelledby="vendorcreateLabel" aria-hidden="true">
            <div className="modal-dialog modal-lg">
               <div className="modal-content all-modal-content vendorcreate-modal-content">
                  <div className="modal-header vendorcreate-modal-header d-flex justify-content-between">
                     <h5 className="modal-title vendorcreate-modal-title" id="vendorcreateLabel">
                  ...
                  <div className="modal-container-size modal-body vendorcreate-modal-body">
                     <div className="row">
                        <div className="col-md-12 mt-3">
                           {/* <h6 className="modal-title vendorcreate-modal-title" id="vendorcreateLabel">Settings</h6> */}
                           <ul className="setting-left setting-list p-0 mt-3 lh-lg">
                              <div className="col-md-12 mb-2" style={{borderLeft: "3px solid rgb(57, 203, 229)", paddingLeft: "12px"}}><strong className="darkGray">🗂️ Catalog Management</strong></div>
                              ...
                              <div className="col-md-4">
                                 ...
                                 <div>
                                    ...
                                    />
                                    <label htmlFor="slide2" style={{background:"#004aad"}}></label>
                                 </div></div>
                                 </div>
                                 </div>
                              ...
                              <div className="col-md-12 mb-2 mt-3" style={{borderLeft: "3px solid rgb(57, 203, 229)", paddingLeft: "12px"}}><strong className="darkGray">⚙️ Settings</strong></div>
                              <div className="row ms-2">
                              <div className="col-md-6">
                                 <div className="d-flex gap-4">
                                 <div>🛠 Catalog Setup</div>
                                 <div>
                                    <div className="slide2">
                                    <input
                                    type="checkbox"
                              ...
                              <hr className="bg-secondary" style={{height:"1.9px"}}/>
                                 <div className="col-md-12 mb-2 mt-3" style={{borderLeft: "3px solid rgb(57, 203, 229)", paddingLeft: "12px"}}><strong className="darkGray"><span><i className="fa-brands fa-whatsapp" style={{color:"#25d967",fontSize:"19px"}}></i></span> Whatsapp</strong></div>
                              <div className="row ms-2">
                              <div className="col-md-6">
                                 <div className="d-flex gap-4">
                                 <div>💬 Flow</div>
