        ...
        <div className="main-panel" style={{ paddingTop: "80px" }} >
          <div className="content-wrapper">
            ...
            <div className="row">
                  ...
                  <div class="card-content ">
                   ...
                   <div className="nav-item nav-profile dropdown">
                    ...
                    <div className="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                      <a className="dropdown-item" href="/adminproductlist"
                ...
                <div class="dashboard-card green">
                  ...
                  <div class="card-content">
                   ...
                   <div className="nav-item nav-profile dropdown">
                    ...
                    <div className="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                      <a className="dropdown-item" href="/adminorderlist"
                      >
                        View More</a>
                    </div>
                  </div>
                ...
                <div class="dashboard-card pink">
                  ...
                  <div class="card-content">
                   ...
                   <div className="nav-item nav-profile dropdown">
                    ...
                    <div className="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                      <a className="dropdown-item" href="/adminvendorlist"
                      >
                        View More</a>
                    </div>
                  </div>
                ...
                <div class="dashboard-card yellow">
                  ...
                  <div class="card-content">
                   ...
                   <div className="nav-item nav-profile dropdown">
                    ...
                    <div className="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                      <a className="dropdown-item" href="/adminclientlist"
                      >
                        View More</a>
                    </div>
                  </div>
              ...
              <div className="col-md-4 col-xl-3 col-lg-4 mt-3">
                <div class="dashboard-card yellow">
                  <div class="splash"></div>
                  <div class="card-content">
                    <h4>Shop list</ h4>
                   ...
                   <div className="nav-item nav-profile dropdown">
                    ...
                    <div className="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                      <a className="dropdown-item" href="/adminshoplist"
                      >
                        View More</a>
                    </div>
                  </div>
                ...
                <div class="dashboard-card pink">
                  ...
                  <div class="card-content">
                   ...
                   <div className="nav-item nav-profile dropdown">
                    ...
                    <div className="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                      <a className="dropdown-item" href="/adminuserlist"
                      >
                        View More</a>
                    </div>
                  </div>
              ...
              <div className="col-md-4 col-xl-3 col-lg-4 mt-3">
                <div class="dashboard-card green">
                  ...
                  <div className="nav-item nav-profile dropdown">
                    ...
                    <div className="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                      <a className="dropdown-item" href="/adminreport"
                      >
                        View More</a>
                    </div>
                  </div>
              ...
              <div className="col-md-4 col-xl-3 col-lg-4 mt-3">
                <div class="dashboard-card blue">
                  ...
                  <div className="nav-item nav-profile dropdown">
                    ...
                    <div className="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                      <a className="dropdown-item" href="/adminsetting"
                      >
                        View More</a>
                    </div>
                  </div>
