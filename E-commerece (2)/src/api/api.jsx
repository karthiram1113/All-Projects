export const environment ={
  baseURL: "http://192.168.0.104/Hermon_Ecom/api/"
  // baseURL: "http://localhost/Hermon_Ecom/api/"
}
// const baseURL = "http://localhost/Hermon_Ecom/api/";
const baseURL = "http://192.168.0.104/Hermon_Ecom/api/";
