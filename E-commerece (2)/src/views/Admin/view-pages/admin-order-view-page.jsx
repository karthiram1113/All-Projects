        ...
        <div className="content-wrapper">
            <div class="page-header">
              ...
              <div style={{ textAlign: "right" }}>
                <a type="button" class="btn btn-primary" onClick={() => navigate('/adminorderlist')} data-discover="true" style={{ float: "right", border:"none" }}>Back</a></div>
            </div>
              ...
              <div className="card-body">
                <div className='row'>
                  <div className='col-md-6 '>
                    ...
                    <div
                      className={`badge mb-4 ${status === "Active"
                        ? "badge-success"
