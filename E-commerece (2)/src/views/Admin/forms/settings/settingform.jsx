...
function Settingform() {
  ...
  const [systemLogo, setSystemLogo] = useState(null); // Selected file
  const [websiteCover, setWebsiteCover] = useState(null); // Selected file

  const [currentSystemLogo, setCurrentSystemLogo] = useState(''); // Current image URL from server
  const [currentWebsiteCover, setCurrentWebsiteCover] = useState(''); // Current image URL from server
  ...
  const systemList = async () => {
    ...
    try {
      ...
      setCurrentSystemLogo(fetchedList.map(item => item.logo));
      setCurrentWebsiteCover(fetchedList.map(item => item.cover));
    } catch (error) {
  ...
  const settingEdit = async (e) => {
    ...
    try {
      ...
      if (systemLogo) formData.append('logo', systemLogo);
      if (websiteCover) formData.append('cover', websiteCover);
          ...
          <form class="forms-sample">
            <div className='row'>
              <div className='col-md-6'>
                <div class="coolinput">
                  <label for="input" class="text">System Name</label>
                  <input type="text" onChange={(e) => setSystemName(e.target.value)}
                    value={systemName}
                    id="exampleInputUsername1" placeholder="Enter your System Name" name="input" class="input" />
                </div>
              </div>
              <div className='col-md-6 mb-3'>
                <div class="coolinput">
                  <label for="input" class="text">System Short Name</label>
                  <input type="text" onChange={(e) => setShortName(e.target.value)}
                    value={shortName}
                    id="exampleInputUsername1" placeholder="Enter your System Short Name" name="input" class="input" />
                </div>
              </div>
              ...
              <div className='col-md-6'>
                <div class="coolinput">
                  <label for="input" class="text">System Logo</label>
                  <input type="file" onChange={handleFileChange}

                    id="exampleInputUsername1" placeholder="Enter your System Logo" name="input" class="input" />
                </div>
                <img
                  className='rounded'
                  style={{ width: "150px", height: "150px", marginTop: "10px" }}
                  src={currentSystemLogo ? environment.baseURL + currentSystemLogo : '/assets/images/noimages.jpg'}
                  alt="System Logo"
                />
              </div>
              <div className='col-md-6'>
                <div class="coolinput">
                  <label for="input" class="text">Website Cover</label>
                  <input type="file" onChange={handleFileChange1}
                    id="exampleInputUsername1" placeholder="Enter your Website Cover" name="input" class="input" />
                </div>
                <img
                  className='rounded'
                  style={{ width: "150px", height: "150px", marginTop: "10px" }}
                  src={currentWebsiteCover ? environment.baseURL + currentWebsiteCover : '/assets/images/noimages.jpg'}
                  alt="Website Cover"
                />
              </div>
