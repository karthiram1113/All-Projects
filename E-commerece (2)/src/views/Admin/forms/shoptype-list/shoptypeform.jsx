          ...
          <form class="forms-sample">
              ...
              <div className='col-md-6'>
                <div class="coolinput">
                  ...
                  <input type="text"
                    ...
                    id="exampleInputEmail1" placeholder="Enter your shop type" name="input" class="input" 
            ...
            <div className='button-center over-all-btn'>
             <Link
              ...
              {urlName == "Create" ? <button type="submit" onClick={shopTypeApi} class="btn btn-gradient-primary me-2">Create</button>:
        <button type="submit"
           onClick={shopEdit} 
