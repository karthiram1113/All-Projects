        ...
        <div style={{ paddingTop: "80px" }} className="main-panel">
          <div className="content-wrapper">
            <div className="page-header">
              ...
              <button onClick={() => navigate("/adminvendorview" + "/Create")} style={{
                // width: "120px",
                // float: "right",
                // border: "0px",
                padding: "15px 25px",
                          ...
                          <td className="clients">
                            ...
                            <div className="d-flex gap-3">
                              <OverlayTrigger className="tool-tip" placement="top" overlay={<Tooltip >View</Tooltip>}>
                                <a href="#">
                                  <Link
                                    to={{ pathname: `/adminvendorget/${list.id}` }} className="eye"
                                  >
                              ...
                              <OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
                                  <a href="#">
                                  <Link
                                    to={{ pathname: `/adminvendorview/${list.id}` }} className="edit"
                                  >
