  ...
  const fetchTeamsDetails = async () => {
    try {
      ...
      if (res.apiStatus.code === "200") {
        setViewData(res.responseData.TeamDetailsView);
      } else {
              ...
              <div className="card">
                <div className="card-body">
                  {loading ? (
                    ...
                    <>
                      <img
                        src={`${baseURL}${viewData.imgData.path}${viewData.imgData.altered_file_name}`}
                      ...
                      <h3 className="mb-3">{viewData.role}</h3>
                      ...
                      <div className="mt-4 d-flex">
                        ...
                        >
                          <input
                            type="checkbox"
                            checked={viewData.active_status === "1"}
                            readOnly
                          />
