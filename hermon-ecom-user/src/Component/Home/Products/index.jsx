    ...
    return (
        <>
            <div className="d-flex justify-content-between">
                ...
                <Link to={'/Productlist'} className="view-all-product-main"><p className="product-view-all">View All <FontAwesomeIcon icon={faShareFromSquare} /></p></Link>
            </div>
            {loading ? (
                <Loading />
            ) : (
                ...
                <div className="row">
                    {list.slice(0, 10).map((value,item) => (
