...
const [editId,setEditId]=useState("")
  ...
  const handleEmojiClick = (emojiData: { emoji: string }) => {
    // setResponseText(responseText + emojiData.emoji);
...
if(selectedOption=="text"){
  ...
  const handleGetBotbyID=()=>{
   ...
   const handleImageChange = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    // if (!validTypes.includes(file1.type)) {
...
const handleEditPopulate=(value: any,listData:any)=>{
  ...
  setbotName(listData.name)
    ...
    if(messageBody?.url)setSelectedOption("image")
...
const validateListSectionWithStructure = (
 ...
 const handleSubmitBot=()=>{
  ...
  if (resType === "media" && (!imgUrl || !caption)) {
    return;
  }

  if (
    interactiveType === "reply" &&
    (!imgUrl || !caption || !replyTextInput1 || !replyTextInput2 || !replyTextInput3)
  ) {
    console.log("reply")
    return;
  }
  ...
  if (
    interactiveType === "cta" &&
    (!imgUrl || !caption || !ctaTextInput || !ctaURLInput)
  ) {
    console.log("cta")
    return;
  }
  ...
  <div className="col-md-12 px-3 login-input-group">
                  ...
                  <div className="card card-details shadow-sm rounded border chat-form-card p-3 border mt-5">
                    ...
                    <div className="modal-body four-input row">
                      ...
                      <label className="radio-container full-click">
                        <input value="custom" onChange={handleChangeResponce}  type="radio" id="option1" name="options" />
                       <span> Custom Responce</span>
                       </label>
                  ...
                  <div className="modal-header border-0">
                    <div className="col-md-12 px-3">
                      ...
                      {(selectedOption === "image" || selectedOption === "video" || selectedOption === "document") && (
                        ...
                        <div className="vendor-create-container">
                           <input autoComplete="off" type="text" id="vendor-crt-input" value={caption}onChange={(e)=>setCaption(e.target.value)}
                            className={`vendor-crt-input loginfilled-frame-username  ${submit && caption.length==0 ? 'error' : ''}`} placeholder=" " required />
                           <label htmlFor="vendor-crt-input" className="vendor-crt-label"><i className="fa-solid fa-store"></i> Captions</label>
                        </div>
                        {submit && caption.length == 0 ? <div className='text-start text-danger error-message-required'>Caption is required</div> : <></>}
                        ...
                        <div className="row">
                          {/* <div className="col-md-4 ">
                            ...
                            <input
                              ...
                              id="button-input"
                              name="button1"
                              value={replyTextInput1}
                              onChange={(e)=>setreplyTextInput1(e.target.value)}
                              className="chat-bot-inputss"
                            /> */}
...
<div className="col-md-4 login-input-group ">
                        <div className="vendor-create-container">
                           ...
                           <label htmlFor="vendor-crt-input" className="vendor-crt-label"> Button 1</label>
                        </div>
                        ...
                        <div className="vendor-create-container">
                           <input autoComplete="off" type="text" id="vendor-crt-input"  value={replyTextInput2}
                              onChange={(e)=>setreplyTextInput2(e.target.value)}
                            className={`vendor-crt-input loginfilled-frame-username  ${submit && replyTextInput2.length==0 ? 'error' : ''}`} placeholder=" " required />
                           <label htmlFor="vendor-crt-input" className="vendor-crt-label"> Button 2</label>
                        </div>
                        {submit && replyTextInput2.length == 0 ? <div className='text-start text-danger error-message-required'>Button 2 is required</div> : <></>}
                        ...
                        <div className="vendor-create-container">
                           <input autoComplete="off" type="text" id="vendor-crt-input"  value={replyTextInput3}
                              onChange={(e)=>setreplyTextInput3(e.target.value)}
                            className={`vendor-crt-input loginfilled-frame-username  ${submit && replyTextInput3.length==0 ? 'error' : ''}`} placeholder=" " required />
                           <label htmlFor="vendor-crt-input" className="vendor-crt-label"> Button 3</label>
                        </div>
                        {submit && replyTextInput3.length == 0 ? <div className='text-start text-danger error-message-required'>Button 3 is required</div> : <></>}
      ...
      {/* Full-width input */}
      <div className="col-md-12 px-1 login-input-group">
        <div className="vendor-create-container">
          <input
...
<div className="col-md-2">
                  ...
                  <button type="button" id="botModalClose" className="vendor-crt-btn" style={{background:"#71717a"}} data-bs-dismiss="modal">Close</button>
                    <button
                      type="submit"
                      className="vendor-crt-btn"
                                ...
                                <td className="align-middle vendor-login-td">
                                  ...
                                  <div className="actionEdit-tooltip-container">
                                    <button
                                      ...
                                      onClick={() => {handlebotReplyGet(listData?.id)}}
                                    >
