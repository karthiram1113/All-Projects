...
import LogoutAPI from '../../api/services/LoginApi';
...
function Navbar() {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      console.log(responseData,"handlelogout")
          ...
          {/* <div className="search-field d-none d-md-block">
            <form className="d-flex align-items-center h-100" action="#">
              <div className="input-group">
                ...
                <input type="text" className="form-control bg-transparent border-0" placeholder="Search News" />
              </div>
            </form>
          </div> */}
