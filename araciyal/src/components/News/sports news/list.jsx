...
import { Sports, TNdeleteProduct, productListss } from '../../service/apiserver'; 
...
function Sports_News() {
  ...
  const fetchDataList = async (pageNumber) => {
    ...
    try {
      const responseData = await Sports(token, pageNumber - 1, recordsPerPage); 
      ...
      if (responseData.apiStatus.code === "200") {
        ...
        localStorage.setItem("SportsNewscount", totalRecords);
            ...
            <div className="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ul className="breadcrumb">
                  <button onClick={() => navigate("/Sportsnews/create")} className="btn btn-primary">Add</button>
                </ul>
              </nav>
            </div>
            <div className="card">
                          ...
                          {list.map((value, ind) => (
                            <tr key={value.id}>
                              ...
                              <td className='text-start'>
                                {truncateText(value.title, 3, 9, value.news_id, "title")}
                              ...
                              <td className="clients">
                                <li>
                                  <Link to={`/Sportsnews/Edit/${value.news_id}`} className="edit">
