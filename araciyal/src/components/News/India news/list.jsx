...
import { India, TNdeleteProduct, productListss } from "../../service/apiserver"; // Import deleteVendor
...
function India_News() {
  ...
  const fetchDataList = async (pageNumber) => {
    ...
    try {
      const responseData = await India(token, pageNumber - 1, recordsPerPage);
      ...
      if (responseData.apiStatus.code === "200") {
        ...
        localStorage.setItem("Indianews", totalRecords);
            ...
            <div className="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ul className="breadcrumb">
                  <button
                    onClick={() => navigate("/IndiaNews/create")}
