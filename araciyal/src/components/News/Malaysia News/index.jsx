...
import {
  ...
  TNdeleteProduct,
  productListss,
} from "../../service/apiserver"; // Import deleteVendor
...
function Malaysia_news() {
  ...
  const fetchDataList = async (pageNumber) => {
    ...
    try {
      const responseData = await Malaysia(
        token,
        pageNumber - 1,
        recordsPerPage
      );
      ...
      if (responseData.apiStatus.code === "200") {
        ...
        localStorage.setItem("MalaysiaNews", totalRecords);
            ...
            <div className="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ul className="breadcrumb">
                  <button
                    onClick={() => navigate("/MalaysiaNews/create")}
                            ...
                            <tr key={value.id}>
                              ...
                              <td className="clients">
                                ...
                                <li>
                                  ...
                                  <Link
                                    to={`/MalaysiaNews/Edit/${value.news_id}`}
                                    className="edit"
                                  >
