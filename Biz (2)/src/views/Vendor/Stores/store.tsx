...
function VendorStore() {
   ...
   const vendorImg=localStorage.getItem("profileImage");
...
const handleFileDrop = (event: React.DragEvent<HTMLDivElement>) => {
  ...
  try {
    ...
    // Only show toast after successful download trigger
    toast.success(`File downloaded: ${fileName}`);
                                                ...
                                                <tr>
                                                   <td>
                                                      <div className="d-flex px-2">
                                                         <div>
                                                            <img src={Slack} className="avatar avatar-sm rounded me-2" alt="spotify" />
                                                         </div>
                                                         <div className="my-auto">
                                                            <h6 className="mb-0 text-sm">{listData.storeName}</h6>
                                                         </div>
                                                      </div>
                                                   </td>
                                                   <td>
