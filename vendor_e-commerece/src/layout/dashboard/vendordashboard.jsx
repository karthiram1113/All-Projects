...
<nav className="sidebar sidebar-offcanvas" id="sidebar">
  ...
  <ul className="nav">
    ...
    <li className="nav-item">
      <Link to="/Vendorlist" className="nav-link" >
...
<li class="nav-item">
    ...
    <div class="collapse" id="reportsModule">
      <ul class="nav flex-column sub-menu">
        ...
        <li class="nav-item">
          <a class="nav-link" href="pages/icons/font-awesome.html">Monthly Order Report</a>
        </li>
      </ul>
    </div>
  </li>
      ...
      <div className="col-md-6 stretch-card grid-margin">
        <div className="card bg-gradient-danger card-img-holder text-white">
          <div className="card-body">
            ...
            <i
  className="fa-solid fa-list mdi-24px float-end"
  style={{
    fontSize: '36px',
    color: 'white',
    ...
    textAlign: 'center' /* Ensure the icon is centered if it's not already */
  }}
></i>

  <h4 className="font-weight-normal mb-3" style={{textAlign:"center",fontSize: '36px'}}>Total Categories
            </h4>
          
            <h6 className="card-text" style={{fontSize: '36px'}}>4</h6>
          </div>
        </div>
      </div>
      <div className="col-md-6 stretch-card grid-margin">
        <div className="card bg-gradient-info card-img-holder text-white">
          <div className="card-body">
            <img src="assets/images/dashboard/circle.svg" className="card-img-absolute" alt="circle-image" />
            <h4 className="font-weight-normal mb-3 "style={{textAlign:"center",fontSize: '36px'}}>Total Products <i className="fa-solid fa-cubes mdi-24px float-end" style={{
    fontSize: '36px',
    color: 'white',
    ...
    textAlign: 'center' /* Ensure the icon is centered if it's not already */
            ...
            <h6 className="card-text"style={{fontSize: '36px'}}>5</h6>
          </div>
        </div>
      </div>
      <div className="col-md-6 stretch-card grid-margin">
        <div className="card bg-gradient-success card-img-holder text-white">
          <div className="card-body">
            <img src="assets/images/dashboard/circle.svg" className="card-img-absolute" alt="circle-image" />
            <h4 className="font-weight-normal mb-3"style={{textAlign:"center",fontSize: '36px'}}> Total Pending Order          <i
  className="fa-solid fa-list mdi-24px float-end"
  style={{
    fontSize: '36px',
    color: 'white',
...
></i>
            ...
            <h6 className="card-text"style={{fontSize: '36px'}}>1</h6>
          </div>
        </div>
      </div>
    </div>
