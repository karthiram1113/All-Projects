...
import { vendorOrderStatus, vendorOrderView } from '../service/apiserver';
...
function VendorOrderViewPage() {
    ...
    const orderGetMethod = async (vendorId) => {
        try {
            const response = await vendorOrderView(vendorId);
    ...
    const handleSaveStatus = async () => {
        ...
        try {
            ...
            const responseData = await vendorOrderStatus(id, selectedStatus);
            console.log("kkkkkData");
             // Adjust API URL as per your setup
                                ...
                                <div style={{ paddingTop: '30px' }} className="row text-center">
                                    ...
                                    <div className="col-md-6">
                                        <img
                                            ...
                                            src={`${environment.apiBaseUrl}${img}`}
                                            alt=""
                                        />
                                    </div>
                                </div>
