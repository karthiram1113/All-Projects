          ...
          <div class="container">
            ...
            >
              <div class="col-lg-6 text-center">
                <h2>
                  Welcome to <br /> Green Dart <br />
                </h2>
                {/* <p> Building Your Vision with Strength and Precision.</p> */}
                <p>
        ...
        <div className="row" style={{
          ...
          <div className="col-md-4" style={{ backgroundColor: "#4da3d1" }}>
            <p className="rent-info">
              <h1 style={{ color: "black", fontSize: "2.5em", letterSpacing: "1px", textTransform: "capitalize", fontWeight: 400 }}>
                We Build Spaces that Brings Smiles
              </h1>
              {/* <h2 style={{ color: "white", letterSpacing: "1px", fontSize: "1.5em", marginTop: "10px" }}>
                live in dream home
              </h2> */}
              <p style={{ color: "#1b3346", fontSize: "1.1em", fontweight: "300", textTransform: "capitalize", lineHeight: "2em", letterSpacing: "1px" }}>
We build strong, long-lasting residential Building and commercial building with modern designs and premium materials. We team build homes that stand the test of time.              </p>
            </p>
          </div>
          ...
          <div className="col-md-8">
            <div className="row text-center">
              ...
              <div className="col-md-6 white-bg py-4">
                <i className="fas fa-hard-hat homeicon"></i>
                <h3 className="rent-textcolor mt-2">Building Work</h3>
                <p className="rent-para">
Building Your dream home and commercial building with a beautiful appearance, Strength, and with the right vasthu Plan.                </p>
              </div>

              {/* 2 */}
              <div className="col-md-6 white-bg py-4">
                <i className="fas fa-pencil-ruler homeicon"></i>
              ...
              {/* 3 */}
              <div className="col-md-6 white-bg py-4">
                <i className="fas fa-file-signature homeicon"></i>
              ...
              {/* 4 */}
              <div className="col-md-6 white-bg py-4">
                <i className="fas fa-hand-holding-usd homeicon"></i>
